...
def augment_with_s_expr_graphq(split, check_execute_accuracy=False):
    ...
    if split == 'train' or split == 'test':
        if split == 'train':
            dataset = load_json(f'dataset/GraphQ/origin/graphquestions_v1_fb15_training_091420.json')
        elif split == 'test':
            dataset = load_json(f'dataset/GraphQ/origin/graphquestions_v1_fb15_test_091420.json')   
        total_num = 0
        hit_num = 0
        execute_hit_num = 0
